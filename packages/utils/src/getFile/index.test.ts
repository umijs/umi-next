...
describe('getFile', () => {
  it('style file', () => {
    const findCSS = (filename) => getFile({
      base: fixture,
      type: 'css',
      filename,
    })
  ...
  it('js file', () => {
    const findJS = (filename) => getFile({
      base: fixture,
      type: 'js',
      filename,
    })
    const findJSWithoutName = (base) => getFile({
      base,
      type: 'js',
    })
  ...
  it('extra file', () => {
    const findText = (filename) => getFile({
      base: fixture,
      filename,
      extnames: [ '.md', '.txt' ],
    })
  ...
  it('extra order file', () => {
    const findJSOrder = (filename) => getFile({
      base: fixture,
      filename,
      extnames: [ '.jsx', '.js' ],
    })
